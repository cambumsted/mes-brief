...
# (region, lob, partner, description, markets)
RECORDS = [
    # ---- EMEA ----
    ("EMEA", "Surface Consumer", "American Express", "Amex cashback (spend 500, get 100 back), AOV $1,500.", "UK, DE, FR, IT"),
    ("EMEA", "Surface Consumer", "Trade-In programme", "Trade-In top-up.", "UK, DE, FR, IT, ES"),
    ("EMEA", "Surface Consumer", "Paylead", "Extension of Paylead. 10% CPA on min $399 purchase, get up to 8.5% cashback from banking partners.", "FR, BE, ES"),
    ("EMEA", "Surface Consumer", "UNiDAYS", "UNiDAYS relaunch and marketing package. BSKU & Laptop 13\" closed-loop offers.", "UK, FR, DE, IT"),
    ("EMEA", "Surface Consumer", "Student Beans", "Extension of Student Beans partnership. 3% CPA on BSKU & Pro 12\" closed-loop offers.", "UK, DE, FR"),
    ("EMEA", "Surface Consumer", "XDL", "XDL Promo Code Test (15% discount) \u2014 repurposed from 'I am Student' Spring BTS partnership.", "DE"),
    ("EMEA", "Surface Consumer", "ShowRoom Priv\u00e9", "ShowRoom Priv\u00e9: 45% saving on Refurbished Pro 11 BSKU (all SKUs) via vanity promocode.", "FR"),
    ("EMEA", "Surface Consumer", "Behind the Cart", "Behind the Cart feature onboarding to scraping tool.", "UK, FR, DE"),
    ("EMEA", "Surface Commercial", "Trade-In programme", "Trade-In top-up.", "UK, DE, FR, IT, ES"),
    ("EMEA", "Gaming HW", "Trade-In programme", "Trade-In top-up.", "UK, DE, FR, IT, ES"),
    ("EMEA", "M365", "PayPal", "PayPal Cashback (get 15% cashback up to max \u20ac100).", "UK"),

    # ---- Americas ----
    ("Americas", "Surface Consumer, Surface Commercial", "American Express", "Marketing Partnership \u2013 AMEX: Spend $1,000, get $X back.", "US"),
    ("Americas", "Surface Consumer", "Mastercard", "Marketing Partnership \u2013 Mastercard: Get 15% back on purchases $1,000+.", "US"),
    ("Americas", "Surface Consumer", "Trade-In programme", "Trade-In Plus Up.", "US, CA"),
    ("Americas", "Surface Commercial", "Trade-In programme", "Trade-In Plus Up campaign.", "US, CA"),
    ("Americas", "Surface Commercial", "Trade-In programme", "Trade-In Plus Up: multiple assisted opportunities in play with customers that will exhaust current funding.", "US"),
    ("Americas", "Surface Consumer, Surface Commercial, Gaming HW", "PayPal", "Marketing Partnership \u2013 PayPal: Get 15% back on purchases, up to $175.", "US"),
    ("Americas", "Gaming HW", "American Express", "Marketing Partnership \u2013 AMEX: Spend $70 get $15 back; Spend $450 get $80 back.", "US"),
    ("Americas", "Gaming HW", "Trade-In programme", "Trade-In Plus Up campaign.", "US"),
    ("Americas", "M365", "Mastercard", "Marketing Partnership \u2013 Mastercard: Get 20% back on purchases of $99.99+.", "US"),

    # ---- Asia ----
    ("Asia", "Surface Consumer", "American Express", "Amex Cashback Campaign.", "ANZ, JPN, SKI"),
    ("Asia", "Surface Consumer", "American Express", "Q1 Amex campaign overspend cost.", "JPN"),
    ("Asia", "Surface Consumer", "Rakuten", "Rakuten Advertising Bronze.", "JPN"),
    ("Asia", "Surface Consumer", "Trade-In programme", "Trade-In Plus Up [ANZ \u2013 50K, SKI \u2013 15K].", "ANZ, SKI"),
    ("Asia", "Surface Consumer", "Visa / Mastercard", "Visa/Mastercard Co-marketing.", "ANZ"),
    ("Asia", "Surface Consumer", "UNiDAYS", "UNiDAYS Co-marketing.", "ANZ"),
    ("Asia", "Surface Consumer", "Amazon (Prime Day) / Rakuten", "Amazon Prime Day (Prime Day $30K / Rakuten $30K / Paid Media top-up $40K).", "JPN"),
    ("Asia", "Surface Consumer", "Alipay", "Alipay Co-marketing.", "GCR"),
    ("Asia", "Surface Commercial", "American Express", "Amex Cashback Campaign.", "ANZ, JPN, SKI"),
    ("Asia", "Surface Commercial", "Intel", "*NEW* Partnership marketing with Intel.", "ANZ, JPN"),
    ("Asia", "Surface Commercial", "WeChat", "New pipeline acquisition through WeChat Ads.", "GCR"),
    ("Asia", "Surface Commercial", "3PP (Brand Love gift)", "Customize Brand Love gift to increase the un-assisted CVR.", "GCR"),
    ("Asia", "Surface Commercial", "Instalment financing partner", "12 stages free instalment.", "GCR"),
    ("Asia", "Surface Commercial", "American Express", "Amex Co-marketing top-up due to outperformance while keeping strong ROI.", "AU"),
    ("Asia", "Gaming HW", "Alipay", "Alipay Co-marketing Pilot.", "GCR"),
    ("Asia", "Gaming HW", "Trade-In programme", "Trade-In Plus Up for 2TB.", "ANZ"),
    ("Asia", "Gaming HW", "3PP (gifts)", "3PP Gifts.", "GCR"),
    ("Asia", "Gaming HW", "PC Attach (OEM co-marketing)", "PC Attach Co-marketing.", "GCR"),
    ("Asia", "Gaming HW", "Store loyalty programme", "Loyalty program: customize store membership.", "GCR"),
    ("Asia", "Gaming HW", "Xbox Attach programme", "Top-up of Xbox Attach programme to drive additional $30K (1:4 ROI) in Gaming Accessories.", "CN"),
    ("Asia", "Surface Consumer", "3PP (gifts)", "3PP Gifts.", "GCR"),
    ("Asia", "Surface Consumer", "Alipay", "Alipay Co-marketing.", "GCR"),
    ("Asia", "Surface Consumer & Commercial", "Trade-In programme", "Q2 Trade-In Plus Up campaign overspend.", "AU"),
    ("Asia", "Cross LOB", "American Express", "Additional funding to support Amex campaign overperformance in Q3.", "JPN"),
]
